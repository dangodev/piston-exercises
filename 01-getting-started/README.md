...
- Foreground color cycles hues every frame
- Background color inverts fg
...
This tutorial does **_not_** explain concepts used in the game, as those
...
_actually_ drawn to the screen.
